...
const InvoiceDashboard = () => {
  ...
  const applyFilters = () => {
    ...
    // Product filter
if (filters.product) { // keeping original key but changing functionality
  filtered = filtered.filter(invoice =>
    invoice.invoiceNumber && invoice.invoiceNumber.toLowerCase().includes(filters.product.toLowerCase())
  );
}
  ...
  return (
    ...
    <div className="invoice-dashboard">
      <div className="dashboard-header">
        <h1 className="text text-center">Invoice Management</h1>
      </div>
